...
<h1>회원 목록</h1>
	...
	<form action="user-change.do" name="user" method="post">
	<!-- name 속성은 해당 요소를 서버로 제출할 때 사용되는 이름을 나타냅니다 / 다만, controller로 보내면 어차피
	request가 받기때문에 name을 생략해도 된다. -->
	<input type="hidden" name="u_idx" value="${user2.u_idx}">
